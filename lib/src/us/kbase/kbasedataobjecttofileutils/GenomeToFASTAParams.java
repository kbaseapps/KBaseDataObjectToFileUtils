...
public class GenomeToFASTAParams {
    ...
    public GenomeToFASTAParams withIdLenLimit(Long idLenLimit) {
        this.idLenLimit = idLenLimit;
        return this;
    }
    ...
    public GenomeToFASTAParams withWriteOffCodeProtSeq(Long writeOffCodeProtSeq) {
        this.writeOffCodeProtSeq = writeOffCodeProtSeq;
        return this;
    }
