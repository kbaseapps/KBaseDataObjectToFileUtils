...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'KBaseDataObjectToFileUtils'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from KBaseDataObjectToFileUtils.KBaseDataObjectToFileUtilsImpl import KBaseDataObjectToFileUtils  # noqa @IgnorePep8
impl_KBaseDataObjectToFileUtils = KBaseDataObjectToFileUtils(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'KBaseDataObjectToFileUtils'
